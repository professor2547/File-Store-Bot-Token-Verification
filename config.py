...
#Database 
DB_URI = os.environ.get("DATABASE_URL", "os.environ.get("DATABASE_URL", "mongodb+srv://Professor2547:noob55@cluster0.qgsku.mongodb.net/?retryWrites=true&w=majority")
